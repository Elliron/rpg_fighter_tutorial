...
run_ani_R = [pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite_R.png"), pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite2_R.png"),
             pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite3_R.png"),pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite4_R.png"),
             pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite5_R.png"),pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite6_R.png"),
             pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite_R.png")]
 
# Run animation for the LEFT
run_ani_L = [pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite_L.png"), pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite2_L.png"),
             pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite3_L.png"),pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite4_L.png"),
             pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite5_L.png"),pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite6_L.png"),
             pygame.image.load("resources/img/Movement_AnimationsPlayer_Sprite_L.png")]
 
# Attack animation for the RIGHT
attack_ani_R = [pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack_R.png"), pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack_R.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack2_R.png"),pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack2_R.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack3_R.png"),pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack3_R.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack4_R.png"),pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack4_R.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack5_R.png"),pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack5_R.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack_R.png")]
 
# Attack animation for the LEFT
attack_ani_L = [pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack_L.png"), pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack_L.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack2_L.png"),pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack2_L.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack3_L.png"),pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack3_L.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack4_L.png"),pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack4_L.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack5_L.png"),pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack5_L.png"),
                pygame.image.load("resources/img/Attack_AnimationsPlayer_Attack_L.png")]
